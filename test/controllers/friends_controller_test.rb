...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { fullname: @friend.fullname, username: @friend.username } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { fullname: @friend.fullname, username: @friend.username } }
